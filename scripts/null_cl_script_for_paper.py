...
for m1a,m1b,m2a,m2b in zip (m30ss1rh1,m30ss1rh2,m30ss2rh1,m30ss2rh2):
    ...
    m2a.mask=m1a.mask
    m2b.mask=m1a.mask
    m30ssrhdiff.append((m1a+m2a-m1b-m2b)/2.)
...
for m1a,m1b,m2a,m2b in zip (m44ss1rh1,m44ss1rh2,m44ss2rh1,m44ss2rh2):
    ...
    m2a.mask=m1a.mask
    m2b.mask=m1a.mask
    m44ssrhdiff.append((m1a+m2a-m1b-m2b)/2.)
...
for m1a,m1b,m2a,m2b in zip (m70ss1rh1,m70ss1rh2,m70ss2rh1,m70ss2rh2):
    ...
    m2a.mask=m1a.mask
    m2b.mask=m1a.mask
    m70ssrhdiff.append((m1a+m2a-m1b-m2b)/2.)
...
plt.ylim([0,10000])
show()
plt.savefig('/global/homes/p/peterm/plots/clplots/cl_null_30.png')
...
plt.ylim([0,10000])
show()
plt.savefig('/global/homes/p/peterm/plots/clplots/cl_null_44.png')
...
plt.ylim([0,10000])
show()
plt.savefig('/global/homes/p/peterm/plots/clplots/cl_null_70.png')
