...
basefsl='gpeterm/sidelobes/'
fl70ss12fsl=glob(basefsl+'/sims_70ghz/*.fits')
fl70ss12fsl.sort()
fl70=glob(base+'*70*14_survey*.fits')
fl70.sort()


fsl70ss1tqu=hp.read_map(fl70ss12fsl[0],[0,1,2])
fsl70ss2tqu=hp.read_map(fl70ss12fsl[1],[0,1,2])
fsl70ss1tqu=hp.ma(fsl70ss1tqu)
fsl70ss2tqu=hp.ma(fsl70ss2tqu)
for map in fsl70ss1tqu:
    map.mask=(fsl70ss1tqu[1].filled()==hp.UNSEEN).astype(bool)|(fsl70ss2tqu[1].filled()==hp.UNSEEN).astype(bool)    
for map in fsl70ss2tqu:
    map.mask=(fsl70ss1tqu[1].filled()==hp.UNSEEN).astype(bool)|(fsl70ss2tqu[1].filled()==hp.UNSEEN).astype(bool)

d70ss12=pu.get_surv_diff_fname(fl70[0],fl70[1],fwhm=1.,freq=70)
d70ss13=pu.get_surv_diff_fname(fl70[0],fl70[2],fwhm=1.,freq=70)
d70ss34=pu.get_surv_diff_fname(fl70[2],fl70[3],fwhm=1.,freq=70)
