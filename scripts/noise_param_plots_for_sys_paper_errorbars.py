...
wnlevel_18m=np.genfromtxt('wnlevel_marge/LFI18M_err.txt')
wnlevel_24m=np.genfromtxt('wnlevel_marge/LFI24M_err.txt')
wnlevel_27m=np.genfromtxt('wnlevel_marge/LFI27M_err.txt')
...
for width in [18.]:
    ...
    plt.errorbar(wnlevel_18m[:,0]+2.5,wnlevel_18m[:,1],wnlevel_18m[:,2],fmt='g ',label='LFI18M')
    plt.errorbar(wnlevel_24m[:,0]+2.5,wnlevel_24m[:,1],wnlevel_24m[:,2],fmt='b ',label='LFI24M')
    plt.errorbar(wnlevel_27m[:,0]+2.5,wnlevel_27m[:,1],wnlevel_27m[:,2],fmt='r ',label='LFI27M')
...
for width in [8.8]:
    ...
    plt.errorbar(alpha_18m[:,0]+2.5,alpha_18m[:,1],alpha_18m[:,2],fmt='g ',label='LFI18M')
    plt.errorbar(alpha_24m[:,0]+2.5,alpha_24m[:,1],alpha_24m[:,2],fmt='b ',label='LFI24M')
    plt.errorbar(alpha_27m[:,0]+2.5,alpha_27m[:,1],alpha_27m[:,2],fmt='r ',label='LFI27M')
...
for width in [8.8]:
    ...
    plt.errorbar(fk_18m[:,0]+2.5,fk_18m[:,1],fk_18m[:,2],fmt='g ',label='LFI18M')
    plt.errorbar(fk_24m[:,0]+2.5,fk_24m[:,1],fk_24m[:,2],fmt='b ',label='LFI24M')
    plt.errorbar(fk_27m[:,0]+2.5,fk_27m[:,1],fk_27m[:,2],fmt='r ',label='LFI27M')
